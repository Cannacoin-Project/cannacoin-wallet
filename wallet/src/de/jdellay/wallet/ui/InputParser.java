...
import de.jdellay.wallet.util.Io;
...
import com.google.cannacoin.core.Base58;
import com.google.cannacoin.core.DumpedPrivateKey;
import com.google.cannacoin.core.ECKey;
import com.google.cannacoin.core.ProtocolException;
import com.google.cannacoin.core.Transaction;
import com.google.cannacoin.protocols.payments.PaymentRequestException;
import com.google.cannacoin.protocols.payments.PaymentRequestException.PkiVerificationException;
import com.google.cannacoin.protocols.payments.PaymentSession;
import com.google.cannacoin.protocols.payments.PaymentSession.PkiVerificationData;
import com.google.cannacoin.script.Script;
import com.google.cannacoin.uri.BitcoinURI;
import com.google.cannacoin.uri.BitcoinURIParseException;

import de.jdellay.wallet.Constants;
import de.jdellay.wallet.PaymentIntent;
import de.jdellay.wallet.util.Bluetooth;
import de.jdellay.wallet.util.PaymentProtocol;
import de.jdellay.wallet.util.Qr;
	...
	public abstract static class StringInputParser extends InputParser
	{
		...
		public void parse()
		{
			...
			if (input.startsWith("cannacoin:"))
			{
				...
				{
					log.info("got invalid cannacoin uri: '" + input + "'", x);
