...
public class ExchangeRatesProvider extends ContentProvider
{
    ...
    private float ccnBtcConversion = -1;
    ...
    private static final URL CCNSWISSCEX_URL;
	...
	static
	{
		try
		{
            ...
            CCNSWISSCEX_URLL = new URL("http://cannacoin.cc/lastprice");
		}
	...
	public Cursor query(final Uri uri, final String[] projection, final String selection, final String[] selectionArgs, final String sortOrder)
	{
		...
		if (lastUpdated == 0 || now - lastUpdated > UPDATE_FREQ_MS)
		{
			...
			if (newExchangeRates == null)
				newExchangeRates = requestExchangeRates(BITCOINAVERAGE_URL, ccnBtcConversion, userAgent, BITCOINAVERAGE_SOURCE, BITCOINAVERAGE_FIELDS);
			if (newExchangeRates == null)
				newExchangeRates = requestExchangeRates(BLOCKCHAININFO_URL, ccnBtcConversion, userAgent, BLOCKCHAININFO_SOURCE, BLOCKCHAININFO_FIELDS);
			...
			if (newExchangeRates != null)
			{
                ...
                newExchangeRates.put("CCN", new ExchangeRate("CCN", BigInteger.valueOf(100000000), "priceofccn.com"));
	...
	private static Map<String, ExchangeRate> requestExchangeRates(final URL url, float ccnBtcConversion, final String userAgent, final String source, final String... fields)
	{
						...
						for (final String field : fields)
						{
							...
							if (rate != null)
							{
								try
								{
                                	...
                                	BigInteger ccnRate = btcRate.multiply(BigDecimal.valueOf(ccnBtcConversion)).toBigInteger();
