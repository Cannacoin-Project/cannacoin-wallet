...
package de.jdellay.wallet.service;
...
import com.google.cannacoin.net.discovery.*;
import com.google.cannacoin.store.BlockStore;
...
import com.google.cannacoin.core.AbstractPeerEventListener;
import com.google.cannacoin.core.Address;
import com.google.cannacoin.core.Block;
import com.google.cannacoin.core.BlockChain;
import com.google.cannacoin.core.CheckpointManager;
import com.google.cannacoin.core.Peer;
import com.google.cannacoin.core.PeerEventListener;
import com.google.cannacoin.core.PeerGroup;
import com.google.cannacoin.core.ScriptException;
import com.google.cannacoin.core.Sha256Hash;
import com.google.cannacoin.core.StoredBlock;
import com.google.cannacoin.core.Transaction;
import com.google.cannacoin.core.TransactionConfidence.ConfidenceType;
import com.google.cannacoin.core.Wallet;
import com.google.cannacoin.core.Wallet.BalanceType;
import com.google.cannacoin.core.WalletEventListener;
import com.google.cannacoin.store.BlockStoreException;
import com.google.cannacoin.store.SPVBlockStore;
import com.google.cannacoin.utils.Threading;

import de.jdellay.wallet.AddressBookProvider;
import de.jdellay.wallet.Configuration;
import de.jdellay.wallet.Constants;
import de.jdellay.wallet.WalletApplication;
import de.jdellay.wallet.WalletBalanceWidgetProvider;
import de.jdellay.wallet.ui.WalletActivity;
import de.jdellay.wallet.util.CrashReporter;
import de.jdellay.wallet.util.GenericUtils;
import de.jdellay.wallet.util.ThrottlingWalletChangeListener;
import de.jdellay.wallet.util.WalletUtils;
import de.jdellay.wallet.R;
		...
		private void check()
		{
			...
			if (hasEverything && peerGroup == null)
			{
				...
				peerGroup.addPeerDiscovery(new PeerDiscovery()
				{
                    ...
                    String channel = "#cannacoin" + String.format("%02d", i);
